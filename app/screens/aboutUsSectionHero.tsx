    ...
    <div className="w-full h-fit relative bg-white overflow-hidden pt-60 pb-38">
      ...
      <div
        ...
        <div className="flex flex-col items-center justify-center gap-2 text-center">
          <h1 className="reveal blur-[10px] opacity-0 translate-y-7.5 font-instrument-sans text-5xl font-bold tracking-tight text-(--text-main-color)">
        ...
        <p className="reveal blur-[10px] opacity-0 translate-y-7.5 font-instrument-sans text-lg max-w-2xl font-medium text-pretty text-center pt-7.5 text-(--text-main-color)">
