        ...
        <div className="w-full h-auto px-10 py-20 rounded-2xl relative border border-(--border-color) bg-(--root-white-color) overflow-hidden flex flex-col items-center gap-10">
          ...
          <div
            ...
            <div className="flex flex-col items-center justify-center gap-2">
              <h2 className="reveal-text-animation font-instrument-sans text-5xl font-bold tracking-tight text-(--text-main-color)">
            ...
            <p className="reveal-text-animation font-instrument-sans text-base font-medium text-pretty text-center pt-4 text-(--text-main-color) max-w-[65%]">
            ...
            <div className="w-full flex items-center justify-center gap-6 max-w-xl mx-auto pt-10">
              <CTAButton
                ...
                className="reveal-text-animation min-w-55"
