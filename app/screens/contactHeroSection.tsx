    ...
    <div className="w-full h-fit relative bg-white overflow-hidden pt-55 pb-35">
      ...
      <div
        ...
        <div className="flex flex-col items-center justify-center leading-[1.1]">
          ...
          <h1 className="reveal blur-[10px] opacity-0 translate-y-7.5 font-instrument-sans text-6xl font-bold tracking-tight text-(--text-main-color) pt-1">
            Something <span className="font-playfair-display italic font-semibold">Together</span>
          </h1>
        </div>
        <p className="reveal blur-[10px] opacity-0 translate-y-7.5 font-instrument-sans text-xl max-w-xl font-medium text-pretty text-center pt-4 text-(--text-main-color)">
        ...
        <div className="w-full flex items-center justify-center gap-6 max-w-xl mx-auto pt-10">
          <CTAButton
            ...
            className="reveal blur-[10px] opacity-0 translate-y-7.5 min-w-[200px]"
