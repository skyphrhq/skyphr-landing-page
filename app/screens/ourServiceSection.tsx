  ...
  return (
    <div ref={animationContainer} className="w-full h-auto bg-(--about-us-card-bg) py-25">
      <div className="w-full flex items-center justify-center sticky top-[30vh]">
        <h2 className="bg-clip-text text-transparent bg-linear-to-t from-(--border-color) to-[#a7a7a7] font-black uppercase text-[25vh] font-instrument-sans reveal blur-[10px] opacity-0 translate-y-20">
