...
function CommonHirePageHeroSection({ data }: { data: HireHeroSection }) {
  return (
    <div className="w-full h-auto relative overflow-hidden">
      <HeroBgAbstract />
      <div className="skyphr-container relative h-auto pt-32 pb-20 xl:pt-40 xl:pb-20 overflow-hidden flex flex-col lg:flex-row items-stretch justify-between gap-10">
