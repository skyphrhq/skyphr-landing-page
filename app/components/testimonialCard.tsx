          ...
          <div className="w-full relative">
            <div className="w-full h-full flex flex-col items-start justify-center gap-6 md:gap-10 relative z-10">
              ...
              <div className="w-full flex flex-col items-start justify-start gap-0.5">
                ...
                <span className="block text-xs sm:text-sm text-(--text-secondary-color) font-inter font-normal">{data.role}</span>
              </div>
            </div>
            <Image src={QuoteIcon} alt="Quote Icon" width={280} height={225} className="absolute top-0 right-0 hidden md:block" />
          </div>
        </div>
      </div>
    </div>
